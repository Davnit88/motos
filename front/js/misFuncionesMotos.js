function autoInicioCategoria(){
    ...
    $.ajax({
        url:"http://168.138.149.45:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function pintarRespuestaMotos(response){
...
function cargarDatosMotos(id) {
    $.ajax({
        dataType: 'json',
        url:"http://168.138.149.45:8080/api/Motorbike"+id,
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url:"http://168.138.149.45:8080/api/Motorbike/"+idElemento,
...
function actualizar(idElemento) {
    ...
    if($("#name2").val().length == 0 || $("#brand").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url:"http://168.138.149.45:8080/api/Motorbike/update",
